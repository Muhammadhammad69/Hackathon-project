...
var editResume = document.querySelector("#edit");
editResume === null || editResume === void 0 ? void 0 : editResume.addEventListener("click", function () {
    ...
    var changingResumeText = document.querySelector("#generate-cv");
    var changingResetText = document.getElementById("reset");
    ...
    changingResetText.addEventListener("click", function () {
        // console.log("hi");
