function changeImage(value: string) {
  ...
  const editResume = document.querySelector("#edit") as HTMLButtonElement;
  editResume?.addEventListener("click", () => {
    ...
    const changingResumeText = document.querySelector(
      "#generate-cv"
    ) as HTMLButtonElement;
    const changingResetText = document.getElementById(
      "reset"
    ) as HTMLButtonElement;
