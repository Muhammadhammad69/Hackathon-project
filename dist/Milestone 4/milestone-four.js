...
function changeDisplayStyle(dValueEdit, downloadBtn) {
...
downloadJpeg.addEventListener("click", () => {
    ...
    domtoimage.toJpeg(containerTwo).then((dataUrl) => {
...
downloadPdf.addEventListener("click", () => {
    ...
    html2pdf().from(containerTwo).set(options).save();
});
